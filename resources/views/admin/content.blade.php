                                ...
                                <div class="col-sm-6 col-6">
                                    <div class="description-block border-right">
                                        <img src={{ URL::asset('dist/img/Logo.jpg') }} alt="User Avatar"
                                            class="img-size-60 mr-3 img-circle" style="margin-bottom: 20px" width="170px">
                                        <h4 class="description-percentage" style="color: rgb(83, 167, 92)"><i
                                                class="fas fa-street-view"></i>
                                            SHREE VARSHAN</h4>
                                        <span class="description-text">BE CSE - C</span>
                                    </div>
                                    <!-- /.description-block -->
                                </div>
                                <!-- /.col -->
                                <div class="col-sm-6 col-6">
                                    <div class="description-block" style="margin-top: 80px">
                                        <form action={{ route('admin.student.add') }} method="POST">
                                            ...
                                            <input type="text" name="labname" value={{ urlencode(Auth::user()->labname) }} id="labname" hidden>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-12">
                                        <div class="description-block ">
                                            <h1 style="margin:5%">{{ session('message') }}</h1>
                                        </div>
                                        <!-- /.description-block -->
                                    </div>
                                    <!-- /.description-block -->
