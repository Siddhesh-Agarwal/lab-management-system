                    ...
                    <div class="col-12">
                        <div class="card" style="margin: 1%">
                            <div class="card-header">
                                ...
                                <form method="post" action="{{ url('superadmin/saveac') }}" class="row g-3"
                                    style="margin-top: 15px">
                                    @csrf
                                    <label for="ac_model">Model Name</label>
                                    <input type="text" class="form-control" name="ac_model" id="ac_model"
                                        placeholder="Enter Model Name" required>
                                    <label for="ac_capacity">AC Capacity</label>
                                    <input type="text" class="form-control" name="ac_capacity" id="ac_capacity"
                                        placeholder="Enter ac capacity" required>
