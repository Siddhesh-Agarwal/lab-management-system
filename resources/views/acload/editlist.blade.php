                    ...
                    <div class="col-12">
                        <div class="card" style="margin: 1%">
                            <div class="card-header">
                                ...
                                <form method="post" action="{{ url('superadmin/updateac') }}" class="row g-3"
                                    style="margin-top: 15px">
                                    @csrf
                                    <input type="hidden" name="id" value="{{ $data->id }}">
                                    <label for="ac_model">AC Name</label>
                                    <input type="text" class="form-control" name="ac_model" id="ac_model"
                                        placeholder="Enter Model Name" required  value="{{ $data->ac_model }}">
                                    <label for="ac_capacity">Capacity</label>
                                    <input type="text" class="form-control" name="ac_capacity" id="ac_capacity"
                                        placeholder="Enter serial number" required  value="{{ $data->ac_capacity }}">
                                    ...
                                    <div style="display:flex; justify-content:space-between; width:100%; margin-top:2%">
                                        ...
                                        <a href='{{ url('superadmin/acload') }}' class="btn btn-danger">Back</a>
                                    </div>
                                </form>
                            </div>
                        </div>
