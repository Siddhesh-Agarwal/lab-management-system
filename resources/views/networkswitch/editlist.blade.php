                        ...
                        <div class="card" style="margin: 1%">
                            <div class="card-header">
                                <div style="width: max-content">
                                    <ol class="breadcrumb" >
                                        <li class="breadcrumb-item" style="color:black">Add Switch</li>
                                    </ol>
                                </div>
                                <form method="post" action="{{ url('superadmin/updateswitch') }}" class="row g-3"
                                    style="margin-top: 15px">
                                    @csrf
                                    <input type="hidden" name="id" value="{{ $data->id }}">
                                    <label for="ac_model">Switch Name</label>
                                    <input type="text" class="form-control" name="switch_model" id="switch_model"
                                        placeholder="Enter Model Name" required  value="{{ $data->switch_model }}">
                                    ...
                                    <div style="display:flex; justify-content:space-between; width:100%; margin-top:2%">
                                        ...
                                        <a href='{{ url('superadmin/switch') }}' class="btn btn-danger">Back</a>
                                    </div>
                                </form>
                            </div>
                        </div>
