...
class LablistController extends Controller
{
    ...
    public function edita($id)
    {
        $labNames = Lab_Table::get();
        $data = Lablist::where("id", "=", $id)->first();
        return view("lablistadmin.editlist", [
            "data" => $data,
            "labNames" => $labNames,
        ]);
    }
    ...
    public function edit_listing_labs($id)
    {
        ...
        return view("lab.listinglabedit", [
            "data" => $data,
            "labs" => $labs,
            "totalDeviceCount" => $totalDeviceCount,
            "totalTempCount" => $totalTempCount,
